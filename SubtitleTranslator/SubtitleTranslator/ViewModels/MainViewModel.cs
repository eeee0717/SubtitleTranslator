...
public partial class MainViewModel : ViewModelBase
{
  ...
  [ObservableProperty] private SidebarListItemTemplate? _selectedSidebarListItem;
  partial void OnSelectedSidebarListItemChanged(SidebarListItemTemplate? value)
  {
  ...
  public ObservableCollection<SidebarListItemTemplate> SidebarItems { get; } = new()
  {
    new SidebarListItemTemplate(typeof(SubtitleFilePageViewModel), "TranslateRegular", "字幕文件翻译"),
  };
...
public class SidebarListItemTemplate
{
  ...
  public SidebarListItemTemplate(Type type, string iconKey, string label)
  {
    ModelType = type;
    Label = label;
